<!-- <template>
    <section class="relative w-full overflow-hidden min-h-screen flex items-center py-16 md:py-20" id="home_hero"> -->
        <template>
    <section 
        class="relative w-full overflow-hidden min-h-screen flex items-center py-16 md:py-20" 
        id="home_hero"
        :style="heroBgStyle">
            ...
            <div class="grid lg:grid-cols-2 gap-10 xl:gap-14 items-center">
                ...
                <div class="flex flex-col md:mt-0 mt-20 justify-center">
                    <div class="lg:text-left" data-aos="fade-right">
                        <!-- leading-tight > leading-[1.4] py-2 -->
                ...
                <div class="relative group">
                    <!-- <div class="relative z-10 mx-auto lg:mx-0 backdrop-blur-sm rounded-full p-4
                               w-[260px] h-[260px]
                               sm:w-[320px] sm:h-[320px]
                               md:w-[400px] md:h-[400px]
                               lg:w-[500px] lg:h-[500px]
                               xl:w-[550px] xl:h-[550px]" :style="{
...
// Compute the style based on the selection
...
h1 {
    ...
    /* This prevents the browser from cutting off the descenders */
