...
// Helper utility function to cleanly map paths into hosted URLs
...
const projects = ref([
    {
        ...
        category: 'Dashboard',
        slides: [
            getImageUrl('admin-dashboard.png'),
            getImageUrl('admin-dashboard-1.png'),
            getImageUrl('admin-dashboard-2.png'),
        ],
        currentSlide: 0,
        technolg: [
    ...
    },
    {
        ...
        category: 'Portfolio',
        slides: [
            getImageUrl('portfolio-web.png'),
            getImageUrl('portfolio-web-1.png'),
            getImageUrl('portfolio-web-2.png'),
            getImageUrl('portfolio-web-3.png'),
            getImageUrl('portfolio-web-4.png'),
        ],
        currentSlide: 0,
        technolg: [
    ...
    },
    {
        ...
        category: 'Social',
        slides: [
            getImageUrl('spider15.png'),
            getImageUrl('spider15-0.png'),
            getImageUrl('spider15-1.png'),
            getImageUrl('spider15-2.png'),
            getImageUrl('spider15-3.png'),
            getImageUrl('spider15-4.png'),
            getImageUrl('spider15-5.png'),
            getImageUrl('spider15-6.png'),
            getImageUrl('spider15-7.png'),
            getImageUrl('spider15-8.png'),
            getImageUrl('spider15-9.png'),
            getImageUrl('spider15-10.png'),
        ],
        currentSlide: 0,
        technolg: [
    ...
    },
    {
        ...
        category: 'Social',
        slides: [
            getImageUrl('mautic.png'),
            getImageUrl('mautic-1.png'),
            getImageUrl('mautic-2.png'),
            getImageUrl('mautic-3.png'),
            getImageUrl('mautic-4.png'),
        ],
        technolg: [
